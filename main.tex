...
\begin{frame}
	...
	\hspace*{-1cm}\begin{tikzpicture}
		\node at (0, 0) {\includegraphics[height=7cm]{advact_polspec_forecast.png}};
		\node at (6, 2) {\includegraphics[width=4.3cm]{advact_cluster_forecast.pdf}};
		\node at (6,-2) {\includegraphics[width=4cm]{advact_dsfg_forecast.pdf}};
	\end{tikzpicture}
\end{frame}
% 45 * End
