...
\begin{frame}
	...
	\vspace{-1cm}
	\begin{center}
	{\footnotesize The source code for this talk can be found at {\color[rgb]{0,0.7,0}https://github.com/amaurea/actpol\_talk\_2015}}
	\end{center}
\end{frame}
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{planck_esa_history_universe.jpeg}}%
...
\begin{frame}{The Cosmic Microwave background}
	\begin{tikzpicture}
		...
		\uncover<1>{\node at (6,-0.5) {\includegraphics[width=5cm]{mtot.png}};}
		\uncover<2>{\node at (6,-0.5) {\includegraphics[width=5cm]{mdelta.png}};}
		\uncover<3>{\node at (6,-0.5) {\includegraphics[width=6cm]{cobe_firas_blackbody.png}};}
		\uncover<4>{\node at (6,-0.0) {\includegraphics[width=2cm]{E_pattern_small}};}
		\uncover<5>{\node at (6,-0.0) {\includegraphics[width=2cm]{B_pattern_small}};}
	\end{tikzpicture}
\end{frame}
...
\begin{frame}{Pure CMB is degenerate}
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\uncover<13>{\node[fill=white,align=center] at (0,-1.5) {
				\includegraphics[height=4cm]{geometric_degeneracy_blake.png}\\
				{\footnotesize Modified from Sherwin et al. 2011 \uncover<0>{g}}};}
			\uncover<17>{\node[fill=white,align=center] at (0,-1.5) {
...
\begin{frame}{Measurements}
	...
	\begin{itemize}
		...
		\item<3-> Planck 2015: $40\sigma$!
	\end{itemize}
	\begin{tikzpicture}
		\uncover<1>{\node at (0,0) {\includegraphics[height=6cm]{act_lens_spec11.pdf}};}
		\uncover<2>{\node at (0,0) {\includegraphics[height=6cm]{cmbonly_lambda.png}};}
